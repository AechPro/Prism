...
def main():
    ...
    parser.add_argument("--loadfile", "-l", type=str, default="")
    parser.add_argument("--alpha", "-a", type=float, default=STEP_SIZE)
    parser.add_argument("--save", "-s", action="store_true", default=False)
    parser.add_argument("--replayoff", "-r", action="store_true", default=False)
    parser.add_argument("--targetoff", "-t", action="store_true", default=False)
