...
def test():
    logger = Logger()
    logger.log_data(1, group_name="a",       var_name="var1")
    logger.log_data(1, group_name="w",       var_name="var2")
    logger.log_data(1, group_name="x",       var_name="var3")
    logger.log_data(2, group_name="x/y",     var_name="var4")
    logger.log_data(2, group_name="x/y",     var_name="var5")
    logger.log_data(2, group_name="x/y",     var_name="var6")
    logger.log_data(3, group_name="x/y/z",   var_name="var7")
    logger.log_data(4, group_name="x/y/z/w", var_name="var8")

    print("INPUT:", logger.current_data)

    """
    should be:
    
    ******************** BEGIN ITERATION 1 REPORT ********************
